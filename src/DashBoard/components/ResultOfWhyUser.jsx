  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl text-center font-bold mb-4">
        This is the ladt why of Mujahid Islam
      </h1>
      <div className="mb-6">
        ...
        <p className="text-gray-700">
          ...
          meaningful relationships and understand others deeply. However, it can
          also lead to emotional fatigue if boundaries aren't maintained, as you
          may prioritize others' needs over your own. Balancing compassion with
          self-care is essential to harnessing this strength effectively.
        </p>
      </div>
          ...
          {strengthsData.map((strength, idx) => (
            <div key={idx} className="p-4 flex flex-col items-start gap-2">
              ...
              <div className="flex items-start gap-3">
                <CiCircleCheck style={{ fontSize: "40px", color: "#00B0F2" }} />
